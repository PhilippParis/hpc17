...
void execute_MY_Gather(collective_params_t* params);
void execute_MY_Scatter(collective_params_t* params);
...
void cleanup_data_Gather2(collective_params_t* params);
void cleanup_data_Gather3(collective_params_t* params);
void cleanup_data_MY_Scatter(collective_params_t* params);
void cleanup_data_Scatter2(collective_params_t* params);
void cleanup_data_Scatter3(collective_params_t* params);
