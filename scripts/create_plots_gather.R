...
df1 <- read_file_data("./data_scatter/scatter_out1.dat", 1)
df2 <- read_file_data("./data_scatter/scatter_out2.dat", 2)
df3 <- read_file_data("./data_scatter/scatter_out3.dat", 3)
df4 <- read_file_data("./data_scatter/scatter_out4.dat", 4)
df5 <- read_file_data("./data_scatter/scatter_out5.dat", 5)
